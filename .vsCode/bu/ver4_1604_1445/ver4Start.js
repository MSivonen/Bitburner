...
export async function main(ns, homeReservedRam = 16) {
	...
	const cores = 1;
	const filterServ = 999999; //remove servers with more than this hack skill needed
	const moneyThresh = 0.5; //don't hack if money is less than this %
	const weakThresh = 1.5; //don't hack if security is more than this %
	const moneyToSteal = 0.25;
	const spamDifficulty = 350; //Spam scripts if required hacking level is less than this
