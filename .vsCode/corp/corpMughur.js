...
export async function main(ns) {
	...
	Script created by Mughur, following step-by-step the guide compiled and arranged by /u/angrmgmt00
	...
	In order for it to work properly in BN11 one of the steps has to be skipped or tinkered.
	...
	*/
	...
	async function invest(i){
		ns.tprint("investmet offer: "+ns.nFormat(ns.corporation.getInvestmentOffer().funds,"0.00a"))
